...
const examResultSchema = new mongoose.Schema({
  ...
  marks: { type: Number, required: false, default: null, min: 0, max: 100 },
  assessmentStatus: { type: String, enum: ["recorded", "missed"], default: "recorded", index: true },
  achievementLevel: { type: String, default: "" },
  achievementPoints: { type: Number, default: null },
