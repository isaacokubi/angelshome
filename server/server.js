...
app.use("/api/auth", require("./routes/auth")); app.use("/api/portal", require("./routes/portal")); app.use("/api/portal/attendance", require("./routes/portalAttendance")); app.use("/api/smis", require("./routes/smis")); app.use("/api/smis/timetable", require("./routes/smisTimetable")); app.use("/api/smis/timetable/resources", require("./routes/smisTimetableResourceAdmin")); app.use("/api/smis/operations", require("./routes/schoolOperations")); app.use("/api/finance", require("./routes/finance")); app.use("/api/reports", require("./routes/reports")); app.use("/api/notifications", require("./routes/notifications")); app.use("/api/whatsapp", require("./routes/whatsapp"));
app.use("/api/contact", require("./routes/contact")); app.use("/api/donations", require("./routes/donations")); app.use("/api/mpesa", require("./routes/mpesa")); app.use("/api/paypal", require("./routes/paypal")); app.use("/api/admin", require("./routes/admin")); app.use("/api/cms", require("./routes/cms"));
