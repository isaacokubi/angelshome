...
app.use("/api/auth", require("./routes/auth")); app.use("/api/portal", require("./routes/portal")); app.use("/api/smis", require("./routes/smis")); app.use("/api/finance", require("./routes/finance")); app.use("/api/notifications", require("./routes/notifications")); app.use("/api/whatsapp", require("./routes/whatsapp"));
