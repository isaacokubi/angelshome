...
export default function PortalShell({ role, children }) {
  ...
  const links = [
    ...
    ...(role === "admin" ? [["Pupils", "/portal/admin/pupils"], ["Teachers", "/portal/admin/teachers"], ["Parents", "/portal/admin/parents"], ["Sponsors", "/portal/admin/sponsors"], ["Relationships", "/portal/admin/relationships"], ["Attendance", "/portal/admin/attendance"], ["Timetable", "/admin/smis/timetable"], ["Operations Centre", "/admin/smis/operations-centre"], ["Reports & Analytics", "/admin/reports"], ["Communications", "/admin/communications"]] : []),
