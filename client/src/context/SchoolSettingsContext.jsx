...
export function SchoolSettingsProvider({ children }) {
  ...
  const refresh = async () => {
    try {
      const payload = await apiRequest("/cms/settings");
