...
function App() {
  ...
  return <>{!hideChrome && <Navbar />}<Routes>
    ...
    <Route path="/portal/admin/pupils" element={<Guard role="admin"><Management type="pupils" /></Guard>} /><Route path="/portal/admin/teachers" element={<Guard role="admin"><Management type="teachers" /></Guard>} /><Route path="/portal/admin/sponsors" element={<Guard role="admin"><Management type="sponsors" /></Guard>} /><Route path="/portal/admin/parents" element={<Guard role="admin"><Management type="parents" /></Guard>} /><Route path="/portal/admin/relationships" element={<Guard role="admin"><SchoolCoordination /></Guard>} /><Route path="/portal/notifications" element={<Guard><Notifications /></Guard>} /><Route path="/portal/teacher/classes" element={<Guard role="teacher"><Learning role="teacher" /></Guard>} /><Route path="/portal/pupil/learning" element={<Guard role="pupil"><Learning role="pupil" /></Guard>} /><Route path="/portal/sponsor/impact" element={<Learning role="sponsor" />} /><Route path="/portal/timetable" element={<Guard><SMISTimetable /></Guard>} /><Route path="/portal/results" element={<Guard><PortalResults /></Guard>} /><Route path="/portal/attendance" element={<Guard><PortalAttendance role="pupil" /></Guard>} />
